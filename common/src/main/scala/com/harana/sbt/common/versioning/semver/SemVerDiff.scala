package com.harana.sbt.common.versioning.semver

import com.harana.sbt.common.versioning.semver.SemVerDiff.Delta.DiffType
import com.harana.sbt.common.versioning.versioning.{ReleaseVersion, SemanticVersion}
