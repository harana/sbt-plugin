package com.harana.sbt.common.versioning.versioning

import java.io.File

import com.harana.sbt.common.versioning.versioning.GitFetcher.FetchResult
import com.harana.sbt.common.versioning.versioning.LowerBoundedSemanticVersion._
import sbt.Keys._
import sbt._
...
object GitVersioningPlugin extends AutoPlugin {
  ...
  override lazy val buildSettings: Seq[Setting[_]] = Seq(
    ...
    versionFromGit := {
      ...
      (ThisProject / autoFetchResult).value
